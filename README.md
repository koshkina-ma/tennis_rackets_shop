...
- сделать постраничную пагинацию и добавить на страницу фильтрацию по бренду (список брендов можно запросить по api/brands)
- использовать компонент некста Image
- добавить шрифт с помощью next/font
- добавить генерацию opengraph-image для страницы ракетки
